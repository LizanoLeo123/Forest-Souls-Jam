...
public class BG_Controller2 : MonoBehaviour
{
    ...
    void CreateBackground()
    {
        ...
        BG.SetActive(true);
        BG.name = "Background2_" + _bgCounter.ToString();
    ...
    {
        string previous = "Background2_" + (_bgCounter - 1).ToString(); //Background_0
        _previousBG = GameObject.Find(previous);
        string current = "Background2_" + _bgCounter.ToString(); //Background_1
